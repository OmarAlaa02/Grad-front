    ...
    <div className="py-8">
      <div className="mb-10 bg-gradient-header p-8 rounded-2xl">
        ...
        <p className="text-gray-600 text-lg max-w-2xl">
          Prepare for your next career opportunity with our AI-powered tools. Create professional CVs and practice with
        ...
        <div>
          ...
          {cvs.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {cvs.map((cv) => (
                <div key={cv.id} className="card group">
                  ...
                  <p className="text-gray-500 text-sm mb-4">Created on {cv.createdAt}</p>
            ...
            <div className="card text-center py-12">
              ...
              <p className="text-gray-500 mb-6 text-lg">You haven't created any CVs yet.</p>
          ...
          {interviews.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="card border-dashed border-2 border-gray-200 flex flex-col items-center justify-center hover:border-teal-300 cursor-pointer group">
                ...
                <p className="text-gray-500 text-sm text-center mt-2">Practice with our AI-powered mock interviews</p>
              </div>
            </div>
          ) : (
            <div className="card text-center py-12">
              ...
              <p className="text-gray-500 mb-6 text-lg">You haven't done any mock interviews yet.</p>
